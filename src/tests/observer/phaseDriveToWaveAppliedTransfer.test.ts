...
import { applyPhaseDriveToWaveTransfer } from '../../observer/phaseDriveToWaveAppliedTransfer.ts';
...
describe('phase drive to wave applied transfer', () => {
  ...
  it('does not include result-coded coherence identifiers in applied transfer source files', () => {
    const source = [
      ...
      readFileSync('src/observer/phaseDriveToWaveAppliedTransfer.ts', 'utf8'),
    ].join('\n');
