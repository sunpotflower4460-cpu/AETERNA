...
## S3 Minimal Natural Feedback ordering

World-loop observer/scenario runs now treat minimal natural feedback in the following order:
...
↓
next tick world / body / return update
```
